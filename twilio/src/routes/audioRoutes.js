...
import { generateGreetingAudio } from '../controllers/callController.js';
...
const verifyTwilioSignature = (req, res, next) => {
  ...
  const url = `https://08f5f6d0a5b9.ngrok-free.app${req.originalUrl}`;
...
router.post('/greeting', generateGreetingAudio);
