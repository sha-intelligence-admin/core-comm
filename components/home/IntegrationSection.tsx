...
const IntegrationsSection: React.FC = () => {
    ...
    return (
        <div
            ...
            className="lg:col-span-4 lg:row-span-1 backdrop-blur-3xl bg-gradient-to-tl from-neonPurple/10 via-aquaGlow/10 to-electricBlue/10 shadow rounded-3xl relative"
        >
            ...
            <div className="bg-transparent flex flex-col lg:flex-row h-full justify-between items-center rounded-3xl p-6 text-start">
                <div className='text-start w-full flex-1'>
                    <motion.h1
                        ...
                        className="text-xl sm:text-2xl md:text-3xl font-medium mb-4 font-montserrat">Powerful Integrations</motion.h1>
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        transition={{ duration: 0.6 }} className="text-xs text-gray-200 mb-2">Seamlessly connect with your favorite tools</motion.div>
                    <ul className="space-y-1 text-gray-300">
                        {[
                            "One-click setup with popular CRMs",
