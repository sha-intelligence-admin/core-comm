      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-background border border-input p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 hover:bg-primary hover:text-white", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
